...
export default function Angioplasty() {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      <ModalHeading title="Angioplasty" className="text-[11px]" />
      ...
      <div className="mt-2">
        ...
        <textarea className="w-full h-28 rounded-md border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 resize-none"></textarea>
      </div>
