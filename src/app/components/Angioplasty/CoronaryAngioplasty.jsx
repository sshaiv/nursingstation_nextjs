    ...
    <div className="space-y-4 mt-2 rounded-2xl border bg-white p-3 shadow-sm">
      ...
      <div className="bg-gray-50 p-3 rounded-md text-sm text-gray-700 max-h-full overflow-y-auto">
        <p>
          ...
          रुकावट या सिकुड़ेपन को ठीक करने के लिये। यह विधि बायपास ऑपरेशन की जगह
          अथवा उसके पूरक के रूप में उपयोग की जा सकती है। यह केथेटेराइजेशन
          प्रयोगशाला में एन्जियोग्राफी की ही भांति की जाती है। एक नली/केथेटर
          फीमोरल धमनी (अथवा हाथ की रेडियल धमनी) के रास्ते हृदय की बीमारग्रस्त
          धमनी के मुहाने पर ले जातेहैं। पूरा कार्य एक्स-रे की सहायता से देखते
          हुए किया जाता है। इसके पश्चात् एक बहुत ही महीन वॉयर जो शरीर अथवा धमनी
          पर कोई दुष्प्रभाव नहीं डालता है, हृदय की बीमारग्रस्त धमनी में पहुंचाया
          जाता है। इस वॉयर का उपयोग एक बैलून / गुब्बारा को रुकावट / सिकुड़ेपन के
          स्थान पर पहुंचाने के लिये किया जाता है। इस बैलून को तरल कॉन्टास्टसे
          फुलाया जाता है जिससे रुकावट वाला स्थान खुल जाता है। हालांकि इस
          प्रक्रिया में अक्सर धमनी में खून का प्रवाह चालू हो जाता है, लेकिन साथ
          ही धमनी में विच्छेदन हो सकता है या बैलून / गुब्बारा सिकुड़ने पर धमनी
          फिर से सिकुड़ जाती है अथवा अगले महीनों में रुकावट (रीस्टेनोसिस) फिर से
          हो सकती है। इसलिये इन सभी समस्याओं से निपटने के लिये, एक धातु की
          जालीनुमा ट्यूब अथवा कॉईल का उपयोग होता है। इसे हम स्टेन्ट कहते है।
          बैलून/गुब्बारे को इसके बाद निकाल लेते है, जबकि स्टेन्ट धमनी में ही
          रहकर उसे लंबे समय तक खुल रखता है।
        </p>
