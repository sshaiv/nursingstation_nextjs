...
export default function ClinicalExamination({ visitid, gssuhid, empid }) {
    ...
    const fields = [
        ...
        { id: 'cyanosis', Label: 'Cyanosis', onChange: setCyanosis, value: cyanosis },
        { id: 'clubbing', Label: 'Clubbing', onChange: setClubbing, value: clubbing },
        { id: 'oedemaFeet', Label: 'Oedema Feet', onChange: setOedemafeet, value: oedemafeet },
        { id: 'icterus', Label: 'Icterus', onChange: setIcterus, value: icterus },
        { id: 'lymphNodes', Label: 'Lymph Nodes', onChange: setLymphnodes, value: lymphnodes },
        ...
        <div className="p-4 bg-purple-50 min-h-screen text-sm text-gray-700">
            ...
            <div className="mt-4 space-y-4">
                <div className="flex flex-wrap items-center gap-4 text-xs">
                    <H3>CVS</H3>
                    <Label><input type="checkbox" className="mr-1" checked={iscvss1} onChange={() => setIscvss1(!iscvss1)} /> S1</Label>
                    <Label><input type="checkbox" className="mr-1" checked={iscvss2} onChange={() => setIscvss2(!iscvss2)} /> S2</Label>
                    <Label><input type="checkbox" className="mr-1" checked={iscvsaddedsound} onChange={() => setIscvsaddedsound(!iscvsaddedsound)} /> Added Sound</Label>
                    <Label><input type="checkbox" className="mr-1" checked={iscvsmurmur} onChange={() => setIscvsmurmur(!iscvsmurmur)} /> Murmur / Click</Label>
                    <Label className="ml-4">Yes 
                        <input 
                            name="cvs" 
                            type="radio" 
                            className="ml-1" 
                ...
                <div className="flex flex-wrap items-center gap-4 text-xs">
                    <H3>RS</H3>
                    <Label><input type="checkbox" className="mr-1" checked={isrsnormalbreath} onChange={() => setIsrsnormalbreath(!isrsnormalbreath)} /> Normal Vesicular Breathing</Label>
                    <Label><input type="checkbox" className="mr-1" checked={isrscrepts} onChange={() => setIsrscrepts(!isrscrepts)} /> Crepts</Label>
                    <Label><input type="checkbox" className="mr-1" checked={isrsronchi} onChange={() => setIsrsronchi(!isrsronchi)} /> Ronchi / Wheeze</Label>
                    <Label className="ml-4">Yes 
                        <input 
                            name="rs" 
                            type="radio" 
                ...
                <div className="flex flex-wrap items-center gap-4 text-xs">
                    <H3>GIT : P/A</H3>
                    <Label><input type="checkbox" className="mr-1" checked={issoft_tense} onChange={() => setIssoft_tense(!issoft_tense)} /> Soft/Tense</Label>
                    <Label><input type="checkbox" className ="mr-1" checked={isdistended_bowel} onChange={() => setIsdistended_bowel(!isdistended_bowel)} /> Distended/Bowel Sounds</Label>
                    <Label><input type="checkbox" className="mr-1" checked={isabsent} onChange={() => setIsabsent(!isabsent)} /> Absent</Label>
                    <Label><input type="checkbox" className="mr-1" checked={ispresent} onChange={() => setIspresent(!ispresent)} /> Present</Label>
                    <Label><input type="checkbox" className="mr-1" checked={isliverp_np} onChange={() => setIsliverp_np(!isliverp_np)} /> Liver P/NP</Label>
                    <Label><input type="checkbox" className="mr-1" checked={isspleen} onChange={() => setIsspleen(!isspleen)} /> Spleen</Label>
                </div>
            ...
            <div className="mt-4 space-y-4 text-xs">
                <ReusableTextareaField id="organomegaly" className='border-2' label="Any other Organomegaly" value={organomegaly} onChange={(e) => setOrganomegaly(e.target.value)} />
                <ReusableTextareaField id="anyOther" className='border-2' label="Any Other" value={cnsanyother} onChange={(e) => setCnsanyother(e.target.value)} />
                <ReusableTextareaField id="localExam" className='border-2' label="Local Examination" value={localexamnation} onChange={(e) => setLocalexamnation(e.target.value)} />
                <ReusableTextareaField id="others" className='border-2' label="Others" value={others} onChange={(e) => setOthers(e.target.value)} />
            </div>
            ...
            <div className="mt-4 flex items-start gap-4">
                ...
                <div className="flex-1">
                    <ReusableTextareaField id="provisionaldiagnosis" label="" value={provisionaldiagnosis} onChange={(e) => setProvisionaldiagnosis(e.target.value)} />
                </div>
            </div>
            ...
            <div className="mt-4">
                ...
                <div className="flex items-center gap-4">
                    <div className="flex gap-4 text-xs mb-2">
                        <Label>
                            <input type="radio" name="nutri" className="mr-1" checked={nutState === 'nutconscious'}
                                onChange={() => setNutState('nutconscious')} /> Conscious
                        </Label>
                        <Label>
                            <input type="radio" name="nutri" className="mr-1" checked={nutState === 'nutaltered'}
                                onChange={() => setNutState('nutaltered')} /> Altered Sensorium
                        </Label>
                        <Label>
                            <input type="radio" name="nutri" className="mr-1" checked={nutState === 'nutcomatose'}
                                onChange={() => setNutState('nutcomatose')} /> Comatose
                        </Label>
                    </div>

                    <div className="flex-1">
                        <ReusableTextareaField id="nutritionalstatusother" label="" value={nutritionalstatusother} onChange={(e) => setNutritionalstatusother(e.target.value)} />
                    </div>
                </div>
            </div>
            ...
            <div className="mt-4 flex items-start gap-4">
                ...
                <div className="flex-1">
                    <ReusableTextareaField id="physiotherapy" label="" value={physiotherapyneeds} onChange={(e) => setPhysiotherapyneeds(e.target.value)} />
                </div>
            </div>
            ...
            <div className="mt-4 flex items-start gap-4">
                ...
                <div className="flex-1">
                    <ReusableTextareaField id="prioradmi" label="" value={investigationdone} onChange={(e) => setInvestigationdone(e.target.value)} />
                </div>
            </div>
            ...
            <div className="mt-4 flex items-start gap-4">
                ...
                <div className="flex-1">
                    <ReusableTextareaField id="ProposedClinicalCarePlan" label="" value={proposedccplan} onChange={(e) => setProposedccplan(e.target.value)} />
                </div>
            </div>
            ...
            <div className="mt-4 flex items-start gap-4">
                ...
                <div className="flex-1">
                    <ReusableTextareaField id="DesiredOutcome" label="" value={desiredoutcome} onChange={(e) => setDesiredoutcome(e.target.value)} />
                </div>
            </div>
