...
export default function SecondPage(visitid, gssuhid, empid, patientData) {
  ...
  return (
    ...
    <div className="flex flex-col md:flex-row gap-4">
      {/* Morse Fall Scale */}
      <div className="flex-1 max-w-full text-black p-2 shadow rounded-lg border overflow-x-auto">
        <h1 className="text-lg font-bold mb-4">MORSE FALL SCALE</h1>
        <table className="w-full border border-gray-400 text-sm">
          <thead>
            <tr className="bg-gray-100">
              <th className="border border-gray-400 p-2 text-left">Item</th>
              <th className="border border-gray-400 p-2 text-left">Scale</th>
          ...
          <tbody>
            ...
            {/* Q3 */}
            <tr>
              <td className="border border-gray-400 p-2">3. Ambulatory aid</td>
              <td className="border border-gray-400 p-2">
                <label className="flex items-center gap-1">
                  <input
                    type="radio"
            ...
            {/* Q6 */}
            <tr>
              <td className="border border-gray-400 p-2">6. Mental status</td>
              <td className="border border-gray-400 p-2">
                <label className="flex items-center gap-1">
                  <input
                    type="radio"
            ...
            <tr className="bg-gray-100 font-semibold">
              <td className="border border-gray-400 p-2">TOTAL SCORE :</td>
      ...
      <div className="flex-1 max-w-full text-black p-4 shadow rounded-lg border overflow-x-auto">
        ...
        <table className="w-full border border-gray-400 text-sm">
          <thead>
            <tr className="bg-gray-100">
              ...
              <th className="border border-gray-400 p-2 text-center">1</th>
              <th className="border border-gray-400 p-2 text-center">2</th>
              <th className="border border-gray-400 p-2 text-center">3</th>
              <th className="border border-gray-400 p-2 text-center">4</th>
          ...
          <tbody>
            {/* Sensory Perception */}
            <tr>
              <td className="border border-gray-400 p-2">Sensory Perception</td>
              {[
                "Completely limited",
                "Very limited",
                "Slightly limited",
            ...
            {/* Moisture */}
            <tr>
              <td className="border border-gray-400 p-2">Moisture</td>
              {[
                "Constantly moist",
                "Very moist",
                "Occasionally moist",
            ...
            {/* Activity */}
            <tr>
              <td className="border border-gray-400 p-2">Activity</td>
              {[
                "Bedfast",
                "Chairfast",
                "Walks occasionally",
            ...
            {/* Mobility */}
            <tr>
              <td className="border border-gray-400 p-2">Mobility</td>
              {[
                "Completely immobile",
                "Very limited",
                "Slightly limited",
            ...
            {/* Nutrition */}
            <tr>
              <td className="border border-gray-400 p-2">Nutrition</td>
              {[
                "Very poor",
                "Probably inadequate",
                "Adequate",
            ...
            {/* Friction & Shear */}
            <tr>
              <td className="border border-gray-400 p-2">Friction & Shear</td>
              {["Problem", "Potential problem", "No apparent problem", ""].map(
                (label, i) => (
                  <td
                    key={i}
